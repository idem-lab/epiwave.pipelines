create_infection_compl_mat <- function (convolution_matrices,
    ...
    with_named_jurisdictions <- setNames(with_named_dates, jurisdictions)
    inf_compl_prob_mat <- do.call(cbind, lapply(with_named_jurisdictions, squareform))
    inf_compl_prob_mat
}
...
#'
#' https://rdrr.io/github/mcfreund/mfutils/man/squareform.html
#'
